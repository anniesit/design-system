...
└── bundles/                     # Generated by build.sh — do not hand-edit
    ├── design-system.css
    ├── design-system.js
    ├── all.css                  # DEPRECATED alias, identical copy — kept so
    └── all.js                   # projects on the old URL keep working
```

> **The bundles were renamed** from `all.{css,js}` to `design-system.{css,js}`,
> because "all.css" tells a stranger nothing. `build.sh` still writes the old
> names as identical copies so live projects linking them do not break. Once
> every project is relinked, delete the alias lines in `build.sh` and the two
> files. Sites still to relink are listed under "Linking the files".
...
(`/bundles/design-system.css`, `/bundles/design-system.js`, `/addons/component-loader.js`,
...
<link rel="stylesheet" href="https://design-system.anniesit.link/bundles/design-system.css">

<!-- In Webflow Project Settings → Custom Code → Before </body> -->
<script src="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js"></script>
<script src="https://design-system.anniesit.link/bundles/design-system.js" defer></script>
```
...
```bash
cp bundles/design-system.css  <project>/css/design-system.css
cp bundles/design-system.js   <project>/js/design-system.js
```
...
block **before** `design-system.js` loads to override defaults for a specific project or page.
...
3. Link it in Webflow **after** `design-system.css` so its variables take effect:
...
```
https://cdn.jsdelivr.net/gh/anniesit/design-system@v0.4.6/bundles/design-system.js
```
